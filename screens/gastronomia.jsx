  ...
  const getAll = async () => {
    ...
    try {
      const allPost = await fetch(
        `https://posts2-api.global.ssl.fastly.net/1/dossier/13/posts?apikey=${API_KEY}&apitoken=${API_TOKEN}&include=bodies,tags,photos,albums,authors,labels,audios,documents,dossiers,collections&filter[isoLanguage]=pt`
      );
